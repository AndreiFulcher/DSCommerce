...
public class ProductService {
    ...
    public Page<ProductMinDTO> findAll(String name, Pageable pageable) { // Serve para buscar todos os produtos com paginação
        ...
        return result.map(ProductMinDTO::new); // Converte cada entidade Product em um ProductDTO
    }
    ...
    private void copyDtoToEntity(ProductDTO dto, Product entity) {
        ...
        entity.getCategories().clear();// Limpa as categorias associadas à entidade para evitar duplicação
